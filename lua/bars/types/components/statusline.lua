...
---@field components bars.statusline.component[] Statusline components.

---@alias bars.statusline.component
---| bars.statusline.section
---| bars.statusline.ruler
---| bars.statusline.mode
---| bars.statusline.diagnostics
---| bars.statusline.branch
---| bars.statusline.bufname
---| bars.statusline.empty
---| bars.statusline.custom
---| bars.statusline.macro
---| bars.statusline.progress

-----------------------------------------------------------------------------

--- Shows current git branch.
---@class bars.statusline.branch
---
...
---@class bars.statusline.diagnostics
---
--- Optional condition for this component.
---@field condition? boolean | fun(buffer: integer, window: integer): boolean
---
...
---@class bars.statusline.progress
---
--- Optional condition for this component.
---@field condition? boolean | fun(buffer: integer, window: integer): boolean
---
